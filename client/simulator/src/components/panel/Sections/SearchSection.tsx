...
import SearchInRegistersTable from '@/components/panel/Search/SearchInRegistersTable';
import SearchInMemoryTable from '@/components/panel/Search/SearchInMemoryTable';
