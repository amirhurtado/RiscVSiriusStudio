...
const memoryTablesSteps = [
  ...
  },
  {
...

   {
    ...
    popover: {
      title: "Pc value",
      description: "While you are executing the instructions you will be able to monitor the PC <span style='color: #009688; font-style: italic;'>(icon)</span>",
    },
    onHighlightStarted: () => {
      setShowProgramTable(true);
    },
  ...
  },
   {
    ...
    popover: {
      ...
      description: "If you click on the cell, the corresponding instruction will be highlighted.<span style='color: #009688; font-style: italic;'>(in the code editor)</span>",
    },
    onHighlightStarted: () => {
      setShowProgramTable(true);
    },
