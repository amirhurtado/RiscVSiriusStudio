...
export default function DMWR() {
  ...
  return (
    <div className='w-full'>
       ...
       <h2 className={` titleInElement top-[-1.9rem]  left-[50%] -translate-x-[50%]  ${overlayMemoryActive && 'overlay-scale'} ${!(currentType === "L" || currentType === "S" || !isFirstStep) && '!text-[#D3D3D3]'  }`}>DMWR</h2>
       </div>
