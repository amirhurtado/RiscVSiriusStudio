...
const edgeGroups: Record<string, string[]> = {
  ...
  'registersUnit->pivotJump4': ['registersUnit->pivotJump4', 'pivotJump4->pivot4', 'pivot4->branchUnit', 'pivot4->muxA'],
  'pivotJump4->pivot4': ['registersUnit->pivotJump4', 'pivotJump4->pivot4', 'pivot4->branchUnit', 'pivot4->muxA'],
...
export const animateLine = (
  ...
  const color = animated ? '#000000' : '#006400';
